...
class LatitudeConstraint extends React.Component {
    constructor(props) {
        super(props)
    ...
    render() {
        let { index, min, max, onMinChange, onMaxChange } = this.props
                ...
                <input
                    ...
                    onBlur={e => {
                        if (parseFloat(e.target.value) !== parseFloat(min)) {
                            onMinChange(index, e.target.value)
                        }
                ...
                <input
                    ...
                    onBlur={e => {
                        if (parseFloat(e.target.value) !== parseFloat(max)) {
                            onMaxChange(index, e.target.value)
                        }
